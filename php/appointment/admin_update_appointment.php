...
if(isset($_POST['update'])) {
    ...
    if($result) {
        ...
        echo "<a href='admin_view_appointments.php'>View Appointment</a>";
    } else {
...
<body>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <input type="text" name="doctor_id" value="<?php echo $doctor_id;?>" required><br><br>
    ...
    <br>
    <a href="admin_view_appointments.php">Go back to view Appointments page</a>
</body>
</html>
